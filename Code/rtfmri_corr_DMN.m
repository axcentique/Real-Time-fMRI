...
TS_plot_savepath = '~/Data/rtfMRI/Output/DMN/run1/';

%%%%%%%%%%%% Block Design
% contrast_mask.right = MRIread('~/Desktop/tutorial/BlockDesignOutput/FSL.feat/stats/zstat1.nii.gz');
% contrast_mask.left = MRIread('~/Desktop/tutorial/BlockDesignOutput/FSL.feat/stats/zstat2.nii.gz');
% contrast_mask.rest = MRIread('~/Desktop/tutorial/BlockDesignOutput/FSL.feat/stats/zstat3.nii.gz');
% func = MRIread('~/Desktop/tutorial/BlockDesignOutput/FSL.feat/filtered_func_data.nii.gz');
% 
% pathEV = '~/Desktop/tutorial/BlockDesignOutput/';
% event_file{1} = 'rightBlock.txt';
% event_file{2} = 'leftBlock.txt';
...
mask = MRIread('~/Desktop/tutorial/BlockDesignOutput/labeling/MNI_PCC_precuneus_func.nii.gz');
...
ev.rest = load([pathEV event_file{3}]);
...
%     TS_mean_combo = [TS_mean_front; TS_mean_front_right; TS_mean_front_left];
%     rtfmri_plot_TS_EV(TS_mean_combo,ev,textTitle,TS_color,TR)
...
%     TS_mean_combo = [TS_mean_poslat; TS_mean_poslat_right; TS_mean_poslat_left];
%     rtfmri_plot_TS_EV(TS_mean_combo,ev,textTitle,TS_color,TR)
    ...
    textTitle = sprintf('Mean voxel time-series of %s v. Rest activation map', net);
