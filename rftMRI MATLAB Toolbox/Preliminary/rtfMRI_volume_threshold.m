function outCell = rtfMRI_volume_threshold(volume,thresh_low,thresh_high,thresh_percent,thresh_nonnegative,norm_flag)
...
for n=1:numel(thresh_low)
    ...
    out.vol = zeros(size(volume));

    index_low = find(volume >= thresh_low(n));
